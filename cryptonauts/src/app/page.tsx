  ...
  return (
    <div className="">
      ...
      <div className="h-full w-full sm:py-32 py-16 bg-primary-700 text-white flex flex-col">
       <div className="lg:flex text-sm sm:text-base px-8">
       <img src="nasabgc.jpg" className="sm:w-[450px] w-[320px] mb-16 sm:mb-0 sm:h-[320px] mx-auto"/>
        <div className="flex flex-col mx-auto lg:text-start text-center">
        
        <p className=" text-xl font-bold mb-8 sm:mb-0 text-center lg:mt-0 mt-8 lg:text-start">Esse projeto visiona parceria com a nasa.</p>
        
        <div className="pl-6 sm:pl-0 mt-4">
